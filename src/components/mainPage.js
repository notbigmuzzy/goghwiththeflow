				...
				<div class="photo-info">
					...
					<div class="social-share">
						...
						<div class="share-buttons">
							<a href="https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(artwork.objectURL)}" onclick="window.open(this.href, 'share-facebook', 'width=580,height=350'); return false;" class="share-button facebook" title="Share on Facebook">
